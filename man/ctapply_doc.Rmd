...
The package uses specific methods to produce the result.  The user have option to print the result.  
The package is supported by four additional functions that return graphical visualization.
